...
public class JogadorXHorarioView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jogador_x_horario_view);
        activity = this;
    ...
    public static void alimentarLista() {
        //JogadorXHorarioAdapter jogadorXHorarioAdapter = new JogadorXHorarioAdapter(activity, new HorarioController(activity).carregaDados());
        //recyclerView.setLayoutManager(new GridLayoutManager(activity,1));
        //recyclerView.setAdapter(jogadorXHorarioAdapter);
    }
